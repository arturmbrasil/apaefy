class MedicinesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @medicine.save
        format.html { redirect_to medicines_url, notice: 'Medicamento cadastrado com sucesso.' }
  ...
  def update
    respond_to do |format|
      if @medicine.update(medicine_params)
        format.html { redirect_to medicines_url, notice: 'Medicamento atualizado com sucesso.' }
  ...
  def destroy
    @medicine.destroy
    respond_to do |format|
      format.html { redirect_to medicines_url, notice: 'Medicamento excluído com sucesso.' }
