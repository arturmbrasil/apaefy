class ProjectsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @project.save
        format.html { redirect_to projects_url, notice: 'Projeto cadastrado com sucesso.' }
  ...
  def update
    respond_to do |format|
      if @project.update(project_params)
        format.html { redirect_to projects_url, notice: 'Projeto atualizado com sucesso.' }
  ...
  def project_params
    params.require(:project).permit(:title, :description, :status, :goals, :value, user_ids: [])
  end
