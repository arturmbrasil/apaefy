...
RSpec.describe DietaryRestrictionsController, type: :routing do
  describe "routing" do
    ...
    it "routes to #new" do
      expect(:get => "/dietary_restrictions/new").to route_to("dietary_restrictions#new")
    end
    ...
    it "routes to #edit" do
      expect(:get => "/dietary_restrictions/1/edit").to route_to("dietary_restrictions#edit", :id => "1")
    end
